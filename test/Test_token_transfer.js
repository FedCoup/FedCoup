...
//     return fedCoupInstance.then(function(instance) {
//         return instance.transferFrom(accounts[0], accounts[1], 100000000000000000000, {from: accounts[1]});                
//     }).then(function(txHash){
//        return fedCoupInstance.then(function(instance){
//         instance.allowance.call(accounts[0], accounts[1]).then(function(approvedAmt){
//           // console.log("second:" + approvedAmt.valueOf());
//           assert.equal(approvedAmt.valueOf(), 0, "100 tokens approved from account 1 to 0 is not reflected");
//         })
//       })
//     })
//   });
